...
const SignUp = () => {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 border border-gray-300 rounded-md shadow-lg">
      <h1 className="text-2xl font-bold mb-6 text-center">Sign Up</h1>

      {error && <div className="text-red-500 text-center mb-4">{error}</div>}

      <form onSubmit={handleSubmit} 
               className="border-2 border-gray-700 flex flex-col gap-5 max-w-xs md:max-w-sm lg:max-w-md rounded-[20px] p-6 mx-auto shadow-lg backdrop-blur-2xl"
>
        <input
          type="text"
          name="name"
